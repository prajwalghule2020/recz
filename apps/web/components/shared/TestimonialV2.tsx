...
const TestimonialV2 = () => {
  ...
  return (
    <RevealAnimation delay={0.3} offset={100}>
      <div
        id="testimonial"
        className="dark:bg-background-6 mx-auto max-w-[740px] rounded-[20px] bg-white px-4 py-6 sm:px-8 sm:py-10 md:px-11 md:py-14"
        role="region"
        aria-label="Customer testimonial">
        {/* testimonial quote */}
        <blockquote id="testimonial-quote" className="mb-8 text-center sm:mb-12 md:mb-16">
          <h3
            ref={quoteRef}
            className="md:text-heading-5 text-lg transition-all duration-300"
        ...
        <div className="space-y-2 text-center">
          ...
          <div className="flex items-center justify-center" id="avatar-group" aria-hidden="true">
            <figure
              className="ring-stroke-1 z-0 -mr-2 size-7 cursor-pointer overflow-hidden rounded-full bg-white ring-2 transition-all duration-300 hover:scale-110 sm:size-8 md:size-9"
            ...
            <figure
              className="ring-stroke-1 z-10 -mr-2 size-8 cursor-pointer overflow-hidden rounded-full bg-white ring-2 transition-all hover:scale-110 sm:size-10 md:size-11"
            ...
            <figure
              className="bg-primary-500 relative z-10 size-12 cursor-pointer overflow-hidden rounded-full ring-2 ring-white transition-all hover:scale-110 sm:size-16 md:size-[72px]"
            ...
            <figure
              className="ring-stroke-1 z-[2] -ml-2 size-8 cursor-pointer overflow-hidden rounded-full bg-white ring-2 transition-all hover:scale-110 sm:size-10 md:size-11"
            ...
            <figure
              className="ring-stroke-1 z-0 -ml-2 size-7 cursor-pointer overflow-hidden rounded-full bg-white ring-2 transition-all hover:scale-110 sm:size-8 md:size-9"
